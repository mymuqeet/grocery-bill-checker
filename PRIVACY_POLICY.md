...
- Advertising ID (resettable by user in Android Settings → Google → Ads)
...
- **AdMob data:** Governed by Google's retention policies (see AdMob Privacy Policy)
...
Source code and this policy: https://github.com/yourusername/grocery-bill-checker (replace with actual repo)
